...
export interface SocketEvents {
    ...
    'signal:register': (data: RegisterMessage, callback: (result: {
        success: boolean;
        nodes?: SignalNode[];
        message?: string;
    }) => void) => void;
    'signal:heartbeat': (data: HeartbeatMessage, callback: (result: {
        success: boolean;
    }) => void) => void;
...
export interface ServerEvents {
    ...
    'player:joined-room': (data: {
        player: Player;
    }) => void;
    'player:left-room': (data: {
        playerId: string;
    }) => void;
    'signal:offer': (data: {
        fromId: string;
